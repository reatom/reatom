...
Defined in: reatomComponent.ts:32

## Functions

### bindField()

> **bindField**\<`T`\>(`field`): `object`

Defined in: [bindField.ts:5](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/react/src/bindField.ts#L5)
...
[`FieldAtom`](core.md#fieldatom)\<`any`, `T`\>
...
`T` | \{ `currentTarget`: `T` *extends* `boolean` ? `object` : `object`; \} | `ChangeEvent`\<\{ `value`: `T`; \}\>
...
Defined in: reatomComponent.ts:82
...
> **reatomComponent**\<`Props`\>(`Component`, `name?`): (`props`) => `ReactNode`

Defined in: reatomComponent.ts:86
...
> **reatomFactoryComponent**\<`Props`\>(`init`, `name?`): (`props`) => `ReactNode`

Defined in: reatomComponent.ts:132
...
Defined in: reatomComponent.ts:34
...
> **useWrap**\<`Params`, `Payload`\>(`callback`, `name?`): (...`params`) => `Payload`

Defined in: reatomComponent.ts:46
