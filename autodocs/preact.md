...
> **reatomContext**: `Context`\<`null` \| [`Frame`](core.md#frame)\<`any`, `any`[], `any`\>\>

Defined in: [index.ts:23](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/preact/src/index.ts#L23)

## Functions

### isSuspense()

> **isSuspense**(`thing`): `boolean`

Defined in: [index.ts:68](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/preact/src/index.ts#L68)
...
> **reatomComponent**\<`Props`\>(`Component`, `name?`): (`props`) => `ComponentChild`

Defined in: [index.ts:72](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/preact/src/index.ts#L72)

#### Type Parameters

##### Props

`Props` *extends* [`Rec`](core.md#rec)
...
> **reatomFactoryComponent**\<`Props`\>(`init`, `name?`): (`props`) => `ComponentChild`

Defined in: [index.ts:117](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/preact/src/index.ts#L117)
...
(`initProps`) => (`props`) => `ComponentChild`
...
> **useFrame**(): [`Frame`](core.md#frame)

Defined in: [index.ts:25](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/preact/src/index.ts#L25)
...
> **useWrap**\<`Params`, `Payload`\>(`callback`): (...`params`) => `Payload`

Defined in: [index.ts:37](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/preact/src/index.ts#L37)
