...
> **FC**\<`Props`\> = (`props`) => [`JSXElement`](#jsxelement)

Defined in: [index.ts:30](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L30)
...
Defined in: [index.ts:28](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L28)

## Variables

### DEBUG

> **DEBUG**: [`Atom`](core.md#atom)\<`boolean`, \[`boolean`\]\>

Defined in: [index.ts:69](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L69)

***

### DOM

> **DOM**: [`Atom`](core.md#atom)\<`Window` & *typeof* `globalThis`, \[`Window` & *typeof* `globalThis`\]\>

Defined in: [index.ts:67](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L67)

***

### stylesheet

> **stylesheet**: [`Atom`](core.md#atom)\<`CSSStyleSheet`, \[`CSSStyleSheet`\]\>

Defined in: [index.ts:79](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L79)
...
Defined in: [index.ts:651](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L651)
...
Defined in: [index.ts:39](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L39)
...
> **Provider**: (`__namedParameters`) => `any`
...
`T` \| [`AtomLike`](core.md#atomlike)\<`T`, `any`[], `T`\>
...
Defined in: [index.ts:643](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L643)
...
Defined in: [index.ts:525](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L525)
...
Defined in: [index.ts:585](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L585)
...
Defined in: [index.ts:587](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/index.ts#L587)
...
> **reatomClassName**(`value`, `name`): [`Computed`](core.md#computed)\<`string`\>

Defined in: [utils.ts:7](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/jsx/src/utils.ts#L7)
...
[`Computed`](core.md#computed)\<`string`\>
