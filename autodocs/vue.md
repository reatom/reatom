...
> **createReatomVue**(`frame`): (`app`) => `void`

Defined in: [index.ts:15](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/vue/src/index.ts#L15)
...
> **reatomRef**\<`T`\>(`target`): `Ref`\<`T`\>

Defined in: [index.ts:41](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/vue/src/index.ts#L41)
...
> **reatomRef**\<`T`\>(`target`): `Readonly`\<`Ref`\<`T`\>\>

Defined in: [index.ts:42](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/vue/src/index.ts#L42)
...
> **useAction**\<`Params`, `Payload`\>(`fn`): (...`params`) => `Payload`

Defined in: [index.ts:31](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/vue/src/index.ts#L31)
...
> **useFrame**(): [`Frame`](core.md#frame)\<`any`, `any`[], `any`\>

Defined in: [index.ts:19](https://github.com/reatom/reatom/blob/ab763471e90118096aeb195bc8e0d1a746c34329/packages/vue/src/index.ts#L19)
