Source URL: https://github.com/woelper/oculante
Title: GitHub - woelper/oculante: A fast and simple image viewer / editor for many operating systems · GitHub
...
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------- | ---------------- |
| Latest commit History[2,355 Commits](/woelper/oculante/commits/master/)2,355 Commits                 |                                                                                                      |                     |                  |
| [.cargo](/woelper/oculante/tree/master/.cargo ".cargo")                                              | [.cargo](/woelper/oculante/tree/master/.cargo ".cargo")                                              |                     |                  |
| [.github](/woelper/oculante/tree/master/.github ".github")                                           | [.github](/woelper/oculante/tree/master/.github ".github")                                           |                     |                  |
| [benches](/woelper/oculante/tree/master/benches "benches")                                           | [benches](/woelper/oculante/tree/master/benches "benches")                                           |                     |                  |
| [egui-modal-diag](/woelper/oculante/tree/master/egui-modal-diag "egui-modal-diag")                   | [egui-modal-diag](/woelper/oculante/tree/master/egui-modal-diag "egui-modal-diag")                   |                     |                  |
| [res](/woelper/oculante/tree/master/res "res")                                                       | [res](/woelper/oculante/tree/master/res "res")                                                       |                     |                  |
| [src](/woelper/oculante/tree/master/src "src")                                                       | [src](/woelper/oculante/tree/master/src "src")                                                       |                     |                  |
| [tests](/woelper/oculante/tree/master/tests "tests")                                                 | [tests](/woelper/oculante/tree/master/tests "tests")                                                 |                     |                  |
| [.gitignore](/woelper/oculante/blob/master/.gitignore ".gitignore")                                  | [.gitignore](/woelper/oculante/blob/master/.gitignore ".gitignore")                                  |                     |                  |
| [CHANGELOG.md](/woelper/oculante/blob/master/CHANGELOG.md "CHANGELOG.md")                            | [CHANGELOG.md](/woelper/oculante/blob/master/CHANGELOG.md "CHANGELOG.md")                            |                     |                  |
| [CODE\_OF\_CONDUCT.md](/woelper/oculante/blob/master/CODE%5FOF%5FCONDUCT.md "CODE_OF_CONDUCT.md")    | [CODE\_OF\_CONDUCT.md](/woelper/oculante/blob/master/CODE%5FOF%5FCONDUCT.md "CODE_OF_CONDUCT.md")    |                     |                  |
| [Cargo.lock](/woelper/oculante/blob/master/Cargo.lock "Cargo.lock")                                  | [Cargo.lock](/woelper/oculante/blob/master/Cargo.lock "Cargo.lock")                                  |                     |                  |
| [Cargo.toml](/woelper/oculante/blob/master/Cargo.toml "Cargo.toml")                                  | [Cargo.toml](/woelper/oculante/blob/master/Cargo.toml "Cargo.toml")                                  |                     |                  |
| [Cross.toml](/woelper/oculante/blob/master/Cross.toml "Cross.toml")                                  | [Cross.toml](/woelper/oculante/blob/master/Cross.toml "Cross.toml")                                  |                     |                  |
| [LICENSE](/woelper/oculante/blob/master/LICENSE "LICENSE")                                           | [LICENSE](/woelper/oculante/blob/master/LICENSE "LICENSE")                                           |                     |                  |
| [PKGBUILD](/woelper/oculante/blob/master/PKGBUILD "PKGBUILD")                                        | [PKGBUILD](/woelper/oculante/blob/master/PKGBUILD "PKGBUILD")                                        |                     |                  |
| [README.md](/woelper/oculante/blob/master/README.md "README.md")                                     | [README.md](/woelper/oculante/blob/master/README.md "README.md")                                     |                     |                  |
| [build.rs](/woelper/oculante/blob/master/build.rs "build.rs")                                        | [build.rs](/woelper/oculante/blob/master/build.rs "build.rs")                                        |                     |                  |
| [build\_deps\_linux.sh](/woelper/oculante/blob/master/build%5Fdeps%5Flinux.sh "build_deps_linux.sh") | [build\_deps\_linux.sh](/woelper/oculante/blob/master/build%5Fdeps%5Flinux.sh "build_deps_linux.sh") |                     |                  |
| [build\_deps\_win.bat](/woelper/oculante/blob/master/build%5Fdeps%5Fwin.bat "build_deps_win.bat")    | [build\_deps\_win.bat](/woelper/oculante/blob/master/build%5Fdeps%5Fwin.bat "build_deps_win.bat")    |                     |                  |
| [build\_mac.sh](/woelper/oculante/blob/master/build%5Fmac.sh "build_mac.sh")                         | [build\_mac.sh](/woelper/oculante/blob/master/build%5Fmac.sh "build_mac.sh")                         |                     |                  |
| [build\_netbsd.sh](/woelper/oculante/blob/master/build%5Fnetbsd.sh "build_netbsd.sh")                | [build\_netbsd.sh](/woelper/oculante/blob/master/build%5Fnetbsd.sh "build_netbsd.sh")                |                     |                  |
| [create\_release.sh](/woelper/oculante/blob/master/create%5Frelease.sh "create_release.sh")          | [create\_release.sh](/woelper/oculante/blob/master/create%5Frelease.sh "create_release.sh")          |                     |                  |
| [icon.ico](/woelper/oculante/blob/master/icon.ico "icon.ico")                                        | [icon.ico](/woelper/oculante/blob/master/icon.ico "icon.ico")                                        |                     |                  |
| [setup\_ext\_libs.sh](/woelper/oculante/blob/master/setup%5Fext%5Flibs.sh "setup_ext_libs.sh")       | [setup\_ext\_libs.sh](/woelper/oculante/blob/master/setup%5Fext%5Flibs.sh "setup_ext_libs.sh")       |                     |                  |
| [winres.rc](/woelper/oculante/blob/master/winres.rc "winres.rc")                                     | [winres.rc](/woelper/oculante/blob/master/winres.rc "winres.rc")                                     |                     |                  |
| View all files                                                                                       |                                                                                                      |                     |                  |
...
### Oculante is currently in maintenance mode. We will only be accepting bug fixes and minor improvements to existing features until we complete our rewrite. More details can be seen here. Progress can be seen on the oculante-next branch.
...
Find and download the correct executable for your operating system on the releases page. The download is small, around 25MB, as we link dependencies statically by default. We also have packages available for ARM Linux. Have a different OS? Please feel free to open an issue if you want your operating system of choice supported!
...
You can see what we're currently working on in our Release Plan, or our Milestones!
...
<https://unsplash.com/@mohsen%5Fkarimi>
...
Oculante can support some additional languages such as Arabic, Chinese, Japanese, Korean. This support depends on if your system has a supported font family installed. One supported font family is Noto Sans.
...
github.com/woelper/oculante 

### Topics

 editor  macos  linux  rust  mac  image  jpg  png  viewer  tiff  psd  image-viewer  windows10  dds  ktx  hdr  exr 
...
Release 0.9.2  Latest Jan 12, 2025 
