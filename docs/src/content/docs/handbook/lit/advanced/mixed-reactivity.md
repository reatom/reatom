...
description: Mixed Reactivity - Reatom Lit integration
---
...
← [Lifecycle](/handbook/lit/advanced/lifecycle) | [Using withReatomElement Mixin](/handbook/lit/advanced/mixin) →
