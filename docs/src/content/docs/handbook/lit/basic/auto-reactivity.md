---
title: Auto Reactivity
description: Auto Reactivity - Reatom Lit integration
---
...
← [When to Use](/handbook/lit/advanced/when-to-use) | [Multiple Atoms](/handbook/lit/basic/multiple-atoms) →
