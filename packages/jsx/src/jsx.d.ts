...
import type { AtomLike, LinkedList, LLNode } from '@reatom/core'
import type * as csstype from 'csstype'

type Primitive = (string & {}) | number | boolean | null | undefined

type LinkedListJSXAtom = AtomLike<LinkedList<LLNode<Element>>> & {
...
export namespace JSX {
  ...
  type ElementChildren = AtomOrGetterMaybe<
    Primitive | ChildNode | Array<ElementChildren>
  >
  ...
  type OnAttributes<T> = {
    [Key in keyof CustomEvents as `on:${Key}`]?:
      | EventHandler<T, CustomEvents[Key]>
      | null
      | undefined
  }
  ...
  interface CustomEventHandlers<T> {
    ...
    'on:securitypolicyviolation'?:
      | EventHandler<T, SecurityPolicyViolationEvent>
      | null
      | undefined
  ...
  type HTMLLinkAs =
    ...
    | 'video'
    | 'worker'
  type HTMLTarget = '_blank' | '_parent' | '_self' | '_top' | '_unfencedTop'
  type HTMLAnchorRel =
    | 'alternate'
    | 'author'
    | 'bookmark'
  ...
  interface AriaAttributes {
    ...
    /**
     * Defines a human-readable, author-localized abbreviated description for
     * the role of an element, which is intended to be converted into Braille.
     *
  ...
  interface BlockquoteHTMLAttributes<
    T = HTMLElementTagNameMap['blockquote'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface ButtonHTMLAttributes<
    T = HTMLElementTagNameMap['button'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface CanvasHTMLAttributes<
    T = HTMLElementTagNameMap['canvas'],
  > extends HTMLAttributes<T> {
    /**
    ...
    'on:webglcontextcreationerror'?:
      | EventHandler<T, WebGLContextEvent>
      | null
      | undefined
  ...
  interface DetailsHtmlAttributes<
    T = HTMLElementTagNameMap['details'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface DialogHtmlAttributes<
    T = HTMLElementTagNameMap['dialog'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface FencedFrameHTMLAttributes<
    T = HTMLElementTagNameMap['fencedframe'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface FieldsetHTMLAttributes<
    T = HTMLElementTagNameMap['fieldset'],
  > extends HTMLAttributes<T> {
    /**
     * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/disabled
  ...
  interface IframeHTMLAttributes<
    T = HTMLElementTagNameMap['iframe'],
  > extends HTMLAttributes<T> {
    /**
  ...
  > extends HTMLAttributes<T> {
    ...
    type?: /**
       ...
       * parameters and relevant keyboard in supporting browsers and devices
  ...
  interface KeygenHTMLAttributes<
    T = HTMLElementDeprecatedTagNameMap['keygen'],
  > extends HTMLAttributes<T> {
  ...
  interface MediaHTMLAttributes<
    T = HTMLElementTagNameMap['audio' | 'video'],
  > extends HTMLAttributes<T> {
    /**
     ...
     * @todo Should support for values ('nodownload' | 'nofullscreen' |
     *   'noremoteplayback' | (string & {}))[]?
     */
    controlslist?:
      | 'nodownload'
      | 'nofullscreen'
  ...
  interface ObjectHTMLAttributes<
    T = HTMLElementTagNameMap['object'],
  > extends HTMLAttributes<T> {
    /**
     * @deprecated
  ...
  interface OptgroupHTMLAttributes<
    T = HTMLElementTagNameMap['optgroup'],
  > extends HTMLAttributes<T> {
    /**
     * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/disabled
  ...
  interface OptionHTMLAttributes<
    T = HTMLElementTagNameMap['option'],
  > extends HTMLAttributes<T> {
    /**
     * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/disabled
  ...
  interface OutputHTMLAttributes<
    T = HTMLElementTagNameMap['output'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface ParamHTMLAttributes<
    T = HTMLElementDeprecatedTagNameMap['param'],
  > extends HTMLAttributes<T> {
    name?: string
    value?: string | number
  }
  interface ProgressHTMLAttributes<
    T = HTMLElementTagNameMap['progress'],
  > extends HTMLAttributes<T> {
    /**
     * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/max
  ...
  interface ScriptHTMLAttributes<
    T = HTMLElementTagNameMap['script'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface SelectHTMLAttributes<
    T = HTMLElementTagNameMap['select'],
  > extends HTMLAttributes<T> {
    /**
     * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete
  ...
  interface SourceHTMLAttributes<
    T = HTMLElementTagNameMap['source'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface TableSectionHTMLAttributes<
    T = HTMLElementTagNameMap['thead' | 'tbody' | 'tfoot'],
  > extends HTMLAttributes<T> {
    /**
     * @deprecated
  ...
  interface TableCellHTMLAttributes<
    T = HTMLElementTagNameMap['td' | 'th'],
  > extends HTMLAttributes<T> {
    /**
     * @deprecated
  ...
  interface TableColHTMLAttributes<
    T = HTMLElementTagNameMap['col' | 'colgroup'],
  > extends HTMLAttributes<T> {
    /**
  ...
  interface TableRowHTMLAttributes<
    T = HTMLElementTagNameMap['tr'],
  > extends HTMLAttributes<T> {
    /**
     * @deprecated
  ...
  interface TextareaHTMLAttributes<
    T = HTMLElementTagNameMap['textarea'],
  > extends HTMLAttributes<T> {
    /**
     * @see https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete
  ...
  interface VideoHTMLAttributes<T> extends MediaHTMLAttributes<T> {
    ...
    'on:enterpictureinpicture'?:
      | EventHandler<T, PictureInPictureEvent>
      | null
      | undefined
  ...
  interface CoreSVGAttributes<T>
    extends AriaAttributes, DOMAttributes<T>, StylePropertyAttributes {
    id?: string
    lang?: string
    tabindex?: `${number}` | number | null | undefined
  }
  ...
  interface IntrinsicElements
    extends
      ElementsAttributesAtomMaybe<HTMLElementTags>,
