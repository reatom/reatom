 ...
 *
 * By default, persisted snapshots are applied as-is. Use this extension together
 * with {@link withToJson} when an atom needs a custom JSON shape, for example
 * restoring a `Date` from a unix timestamp.
 *
